...
alias mountms2_c='mkdir $HOME/ms2 &>/dev/null ; sudo mount -t cifs -o username=jarch_hu,password=123456,uid=$(id -u),gid=$(id -g),cache=none,nostrictsync,nohandlecache //10.8.16.121/jarch_hu/ms2 $HOME/ms2/'
...
alias mountms68_c='mkdir -p $HOME/workspace/SDX6x &>/dev/null ; sudo mount -t cifs -o username=gerrit,password=123456,uid=$(id -u),gid=$(id -g) //10.8.16.68/gerrit/workspace/SDX6x/ $HOME/workspace/SDX6x'
alias mountsg='mkdir $HOME/sg &>/dev/null ; sudo mount -t nfs 10.8.17.89:/home/jarch_hu/sg $HOME/sg'
alias mountsg_c='mkdir $HOME/nas &>/dev/null ; sudo mount -t cifs -o credentials=$HOME/.smbpass,rw,uid=$(id -u),gid=$(id -g),vers=2.0 //10.8.17.89/jarch_hu/ $HOME/nas'
...
alias mountmsc1_c='mkdir -p $HOME/msc1 &>/dev/null ; sudo mount -t cifs -o credentials=$HOME/.smbpass,rw,uid=$(id -u),gid=$(id -g),cache=none,nostrictsync,nohandlecache //10.8.17.236/jarch_hu/msc1 $HOME/msc1/'
