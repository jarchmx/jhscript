...
alias mountms2_c='mkdir $HOME/ms2 &>/dev/null ; sudo mount -t cifs -o username=jarch_hu,password=123456,uid=$(id -u),gid=$(id -g),actimeo=0 //10.8.16.147/jarch_hu/ms2 $HOME/ms2/'
...
alias mountmsc1_c='mkdir -p $HOME/msc1 &>/dev/null ; sudo mount -t cifs -o credentials=$HOME/.smbpass,rw,uid=$(id -u),gid=$(id -g),actimeo=0 //10.8.17.236/jarch_hu/msc1 $HOME/msc1/'
alias mountnas='mkdir $HOME/File &>/dev/null ; sudo mount -t cifs -o credentials=$HOME/.smbpass_askey -o rw,uid=$(id -u),gid=$(id -g),actimeo=0 //10.8.17.116/File $HOME/File/'
